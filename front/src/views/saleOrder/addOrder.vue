    ...
    <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="130px" class="demo-ruleForm" style="width: 500px; margin-left:50px;">
      ...
      <div
        ...
        <el-form-item
          ...
          label="产地 & 类型">
          <el-cascader :options="options" v-model="domain.selectedOptions" placeholder="产地/类型" @change="getStore(index)"/>
        </el-form-item>
        <el-form-item
      ...
      <el-form-item>
        <el-button class="el-icon-circle-plus-outline" @click="addDomain"> 添加商品</el-button>
      </el-form-item>
      <hr style="border: 0.5px solid #dcdfe6">
