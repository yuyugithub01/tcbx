  ...
  <div class="app-container">
      ...
      <el-table-column type="expand" width="30">
        <template slot-scope="props">
          <el-table :data="props.row.details" border>
            ...
            <el-table-column label="尺码" min-width="210" align="center">
              <template slot-scope="scope">
    ...
    <el-dialog :visible.sync="dialogFormVisible" title="修改订单信息">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="140px" style="width: 400px; margin-left:50px;">
        <el-form-item label="产地 & 类型" prop="selectedOptions">
          <el-cascader :options="options" v-model="temp.selectedOptions" placeholder="产地/类型" @change="getStore"/>
        </el-form-item>
        <el-form-item
          :rules="{ required: true, message: '必须选择尺码', trigger: 'change' }"
          label="尺码 & 颜色"
          prop="carId">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        type: [{ required: true, message: '必须选择尺码', trigger: 'change' }],
