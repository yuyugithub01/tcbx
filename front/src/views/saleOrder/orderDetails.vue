<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.carId" placeholder="商品编号" style="width: 160px;" class="filter-item" @keyup.enter.native="handleFilter"/>
    ...
    <el-table
      ...
      <el-table-column label="商品编号" prop="carId" sortable="custom" align="center" min-width="105px">
        <template slot-scope="scope">
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['订单详情编号', '订单编号', '客户编号', '商品编号', '数量', '销售员', '创建时间', '更新时间', '状态']
